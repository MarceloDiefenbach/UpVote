...
public extension Font {
    ...
    struct DesignSystem {
        ...
        public static let bigBold = Font.system(size: 40, weight: .black, design: .default)
        public static let largeTitleBold = Font.system(size: 32, weight: .black, design: .default)
        public static let largeTitleRegular = Font.system(size: 32, weight: .regular, design: .default)
        public static let titleBold = Font.system(size: 24, weight: .black, design: .default)
        public static let titleRegular = Font.system(size: 24, weight: .regular, design: .default)
        public static let normalBold = Font.system(size: 16, weight: .black, design: .default)
        public static let normalRegular = Font.system(size: 16, weight: .regular, design: .default)
        public static let smallBold = Font.system(size: 12, weight: .black, design: .default)
